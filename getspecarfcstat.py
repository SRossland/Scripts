#!/usr/bin/python
# syntax: ./getspecarfcstat.py dir obsid regcore outdir det
...
det=sys.argv[5]
dir=dir+"/"+obsid+"/"
rmfarf=" runmkarf=yes runmkrmf=yes "
...
os.system("rm -f "+dir+"event_cl/"+outdir+"/"+regcore+"_sr_g3.pha")
os.system("grppha "+dir+"event_cl/"+outdir+"/"+regcore+"_sr.pha "+ \
          dir+"event_cl/"+outdir+"/"+regcore+ \
          "_sr_g3.pha 'chkey RESPFILE "+dir+"event_cl/"+outdir+"/"+ \
          regcore+"_sr.rmf & group min 3 & exit'")
